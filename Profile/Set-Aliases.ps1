...
Set-Alias seek Find-FileName
Set-Alias seek-string Find-String

# 3rd party command aliases
Set-Alias g git
...
Set-Alias vs "$env:ProgramFiles\Microsoft Visual Studio\2022\*\Common7\IDE\devenv.exe"
Set-Alias magick "$env:ProgramFiles\ImageMagick-7.1.1-Q16-HDRI\magick.exe"
